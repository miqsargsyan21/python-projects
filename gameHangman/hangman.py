    ...
    while guesses_remaining > 0:
        ...
        if letter in letters_guessed:
            ...
            if warnings_remaining > 0:
                print("Oops! You've already guessed that letter. You now have ", warnings_remaining, "warnings left:", get_guessed_word(secret_word, letters_guessed))
                continue
        ...
        if letter in secret_word:
            ...
            print("Oooops! That letter is not in my word: ",get_guessed_word(secret_word, letters_guessed))
            if letter in vowels:
                guesses_remaining -= 2
            else:
                guesses_remaining -= 1
        ...
        print("-----------")
        print("Sorry, you ran out of guesses. The word was else. Secret word: ", secret_word)
...
def unique_letters(secret_word):
    ...
    for i in range(len(secret_word)-1, -1, -1):
        if not(secret_word.count(secret_word[i]) > 1):
            unique_letters_in_secret_word += secret_word[i]
        else:
            secret_word = secret_word[:i] + secret_word[i+1:]
    return len(unique_letters_in_secret_word)
